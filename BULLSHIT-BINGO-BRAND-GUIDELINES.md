...
**Core positioning:**
"Make a bingo card for the BS your [X] always says."

Rotating words: dad, coworker, uncle, in-laws, roommate, mom, boss, neighbor, friend group
...
**Hero/Landing:**
> Make a bingo card for the BS your **dad** always says.
>
> *(cycles through: dad, coworker, uncle, in-laws, roommate, mom, boss, neighbor, friend group)*
...
### Primary Logo
**Bull$hit!** (stacked with **Bingo** below) + Bingo card icon

- "Bull$hit!" text: Cream (#FFF8E7), with $ in Amber (#F59E0B)
- "Bingo" text: Tan (#D4A574)
- Bingo card icon: 3x3 grid, Cream background, Tan and Amber cells
- Font: Poppins Black (900) for "Bull$hit!", Poppins Bold (700) for "Bingo"
...
The icon is a 3x3 bingo card grid with some cells "marked" in amber.
...
.logo-text-stack .top .amber {
  color: #F59E0B;
}

.logo-text-stack .bottom {
  font-family: 'Poppins', sans-serif;
  font-weight: 700;
  font-size: 1.25rem;
  color: #D4A574;
...
| Context | Usage |
|---------|-------|
| Primary | Icon + stacked text, on brown background |
| Nav/Header | Smaller version, same layout |
| Favicon | 3x3 grid icon only, or "B$" mark |
| App Icon | 3x3 grid on amber background |
| Light background | Brown text, amber $, tan "Bingo" |

### Logo Sizes
- **Large (hero):** Icon 80px, "Bull$hit!" 2.5rem, "Bingo" 1.5rem
- **Medium (default):** Icon 60px, "Bull$hit!" 2rem, "Bingo" 1.25rem  
- **Small (nav):** Icon 40px, "Bull$hit!" 1.5rem, "Bingo" 1rem

### Logo Clear Space
Maintain padding equal to the height of one icon cell on all sides.
...
- Don't change the icon grid pattern
